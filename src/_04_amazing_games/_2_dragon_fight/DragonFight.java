	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
			String question = JOptionPane.showInputDialog("Do you want to attack with a kick or a yell?");
			...
			if(question.equalsIgnoreCase("a yell")) {
				playerAttack=ran.nextInt(10);
			...
			if(question.equalsIgnoreCase("a kick")) {
					playerAttack=ran.nextInt(25);
			...
			JOptionPane.showMessageDialog(null,"Dragon Health Lost = " + playerAttack);					
